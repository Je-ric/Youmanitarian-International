...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.dialog','data' => ['id' => 'approveVolunteerModal-' . $volunteer->id,'maxWidth' => 'xl:max-w-xl lg:max-w-lg md:max-w-md sm:max-w-sm max-w-xs','width' => 'w-full','maxHeight' => 'max-h-[90vh]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('approveVolunteerModal-' . $volunteer->id),'maxWidth' => 'xl:max-w-xl lg:max-w-lg md:max-w-md sm:max-w-sm max-w-xs','width' => 'w-full','maxHeight' => 'max-h-[90vh]']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.close-button','data' => ['modalId' => 'approveVolunteerModal-' . $volunteer->id,'text' => 'Cancel']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['modalId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('approveVolunteerModal-' . $volunteer->id),'text' => 'Cancel']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <form action="<?php echo e(route('volunteers.approve', $volunteer->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Janice\youmanitarian-international\resources\views/volunteers/modals/approveVolunteerModal.blade.php ENDPATH**/ ?>