    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div id="login-form" class="glass-effect rounded-2xl p-6 shadow-xl form-transition form-visible">
                    ...
                    <form method="post" action="<?php echo e(route('login')); ?>" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-800 transition-colors">
                    ...
                    <!-- Google OAuth -->
                    <a href="<?php echo e(route('google.login')); ?>" class="w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-2.5 px-4 rounded-lg border border-gray-300 transition-colors duration-200 flex items-center justify-center">
                        <img src="<?php echo e(asset('assets/images/icons/google-100.png')); ?>" alt="Google" class="w-5 h-5 mr-3">
        ...
        <div class="hidden lg:flex lg:w-1/2 illustration-container items-center justify-center p-8">
            <div class="text-center space-y-8">
                <img src="<?php echo e(asset('assets/images/logo/YI_Logo.png')); ?>" alt="Youmanitarian International" class="w-64 h-64 mx-auto mb-8 object-contain">
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\Janice\youmanitarian-international\resources\views/auth/login.blade.php ENDPATH**/ ?>