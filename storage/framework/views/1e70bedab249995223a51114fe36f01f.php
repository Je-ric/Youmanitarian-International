                ...
                <div class="bg-[#1a2235] px-8 py-8">
                    <div class="flex items-center gap-4">
                        <div class="w-16 h-16 bg-white rounded-xl p-2 flex-shrink-0">
                            <img src="<?php echo e(asset('assets/images/logo/YI_Logo.png')); ?>" alt="Youmanitarian International Logo"
                    ...
                    <div class="mb-8">
                        ...
                        <?php if($invitationMessage): ?>
                            <div class="bg-[#ffb51b]/5 border-l-4 border-[#ffb51b] rounded-r-lg p-4">
                                <p class="text-gray-700 italic">"<?php echo e($invitationMessage); ?>"</p>
                            </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="bg-gradient-to-br from-slate-50 to-gray-50 rounded-xl p-6 border border-gray-200">
                            ...
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                <p class="text-xl font-bold text-[#ffb51b]">
                                    <?php echo e(ucwords(str_replace('_', ' ', $member->membership_type))); ?> Member
                                </p>
                            </div>
                        </div>
                        <!-- Benefits -->
...
<?php echo $__env->make('layouts.sidebar_final', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Janice\youmanitarian-international\resources\views/notifications/show-invitation.blade.php ENDPATH**/ ?>