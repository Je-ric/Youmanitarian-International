...
<div x-data="{ show: false }" x-init="show = true; setTimeout(() => show = false, 3500)" 
        ...
        class="fixed top-5 right-5 z-50 p-4 rounded-lg shadow-xl backdrop-blur-sm border flex items-center space-x-3 max-w-xs sm:max-w-sm md:max-w-md <?php echo e($toast['container']); ?>">
    
    <span class="w-10 h-10 flex items-center justify-center rounded-full <?php echo e($toast['icon_bg']); ?>">
        <i class="bx <?php echo e($toast['icon']); ?> text-white text-xl"></i> 
    </span>

    <div class="flex flex-col">
        <h3 class="font-semibold text-lg"><?php echo e($toast['title']); ?></h3>
...
<?php /**PATH C:\Users\Janice\youmanitarian-international\resources\views/components/feedback-status/toast.blade.php ENDPATH**/ ?>