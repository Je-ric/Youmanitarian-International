...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.dialog','data' => ['id' => 'restoreVolunteerModal-' . $volunteer->id,'maxWidth' => 'xl:max-w-xl lg:max-w-lg md:max-w-md sm:max-w-sm max-w-xs','width' => 'w-full','maxHeight' => 'max-h-[90vh]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('restoreVolunteerModal-' . $volunteer->id),'maxWidth' => 'xl:max-w-xl lg:max-w-lg md:max-w-md sm:max-w-sm max-w-xs','width' => 'w-full','maxHeight' => 'max-h-[90vh]']); ?>
...
<?php $component->withAttributes([]); ?>
        <div class="flex flex-col items-center text-center gap-3">
            ...
            <div class="bg-gray-50 rounded p-2 w-full mt-2">
                <span class="font-semibold text-gray-800 text-xs sm:text-base"><?php echo e($volunteer->user->name); ?></span>
            </div>
        </div>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.close-button','data' => ['modalId' => 'restoreVolunteerModal-' . $volunteer->id,'text' => 'Cancel']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['modalId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('restoreVolunteerModal-' . $volunteer->id),'text' => 'Cancel']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <form action="<?php echo e(route('volunteers.restore', $volunteer->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['variant' => 'table-action-success'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Janice\youmanitarian-international\resources\views/volunteers/modals/restoreVolunteerModal.blade.php ENDPATH**/ ?>