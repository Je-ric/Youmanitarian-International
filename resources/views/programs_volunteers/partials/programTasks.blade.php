<div class="w-full bg-white border border-indigo-100 rounded-xl p-6 mb-6 shadow-sm backdrop-blur-sm">
                        ...
                        <div x-show="showAssign"
                            ...
                            <form action="{{ route('programs.tasks.assign', [$program, $task]) }}" method="POST" class="space-y-2">
                                ...
                                <select name="volunteer_id" required
                                        class="w-full border border-indigo-200 rounded px-3 py-2 text-xs bg-white focus:ring-1 focus:ring-[#6366F1] focus:border-[#6366F1]">
