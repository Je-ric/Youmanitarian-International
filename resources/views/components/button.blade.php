...
@php
    ...
    $styles = [
        ...
        'primary' => 'w-full max-w-[180px] px-6 py-3 rounded-md bg-[#ffb51b] hover:bg-[#ffc449] text-white text-base md:text-lg font-semibold shadow-[0px_5.28px_13.2px_0px_rgba(255,225,164,1.00)] active:scale-95 transition-transform duration-200',
