...
@php
    ...
    $styles = [
        ...
        'disabled'  => 'bg-slate-400 rounded-md shadow-[0px_5.28px_13.2px_rgba(49,56,73,0.24)] text-white text-lg font-semibold tracking-tight cursor-not-allowed transition duration-200',
        'clock_in' => 'bg-[#ffb51b] hover:bg-[#ffc449] text-white px-4 py-2 rounded-md text-sm sm:text-base md:text-lg font-semibold shadow-[0px_5.28px_13.2px_0px_rgba(255,225,164,1.00)] active:scale-95 transition-transform duration-200 w-full',
