    ...
    <section class="w-full bg-white px-6 md:px-16 lg:px-32 py-20">
        <div class="max-w-[1920px] mx-auto flex flex-col lg:flex-row gap-16">
            ...
            <div class="flex flex-col gap-4 lg:w-1/3">
                <span
                    class="inline-block px-4 py-1.5 bg-sky-950 rounded-full text-white font-semibold text-lg tracking-wide">
                    Why Partner With Us
                </span>
                ...
                <p class="text-lg md:text-xl text-zinc-900 leading-relaxed">
                    Join a network of like-minded organizations and individuals. Collaborate with us to make a meaningful
                    impact, grow your brand visibility, and contribute to lasting change in the community.
                </p>
            </div>
            ...
            <div class="flex flex-1 flex-col md:flex-row gap-6">
                ...
                <div
                    class="flex-1 bg-gradient-to-br from-amber-100 to-amber-300 rounded-3xl p-8 flex flex-col gap-4 shadow-lg hover:scale-105 transition-transform duration-300">
                ...
                <div
                    class="flex-1 bg-gradient-to-br from-sky-100 to-sky-300 rounded-3xl p-8 flex flex-col gap-4 shadow-lg hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-base md:text-lg text-zinc-800 leading-relaxed">
                        Connect with other organizations, thought leaders, and community members who share your vision for
                        positive change.
                    </p>
                </div>

                <div
                    class="flex-1 bg-gradient-to-br from-emerald-100 to-emerald-300 rounded-3xl p-8 flex flex-col gap-4 shadow-lg hover:scale-105 transition-transform duration-300">
