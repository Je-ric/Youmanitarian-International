<dialog id="{{ $modalId }}" class="modal" role="dialog" aria-modal="true" aria-labelledby="delete-program-title-{{ $program->id }}">
    <div class="modal-box w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl p-0 overflow-hidden rounded-xl bg-white">
        <x-modal.header>
