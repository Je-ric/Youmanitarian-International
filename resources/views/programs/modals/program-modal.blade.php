...
<dialog id="modal_{{ $program->id }}" class="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title-{{ $program->id }}">
    <div class="modal-box w-11/12 max-w-6xl p-0 overflow-hidden rounded-xl bg-white border border-slate-200 transition-all max-h-[90vh] flex flex-col">
        ...
        <div class="flex flex-col lg:flex-row flex-1 min-h-0 overflow-hidden">
            ...
            <div class="lg:w-2/3 w-full p-6 space-y-6 overflow-y-auto">
                ...
                <article>
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-lg p-4 max-h-48 overflow-y-auto custom-scrollbar">
                ...
                <div class="border-t border-slate-200 pt-6">
                    ...
                    <div class="flex items-center space-x-4 p-4 border border-slate-200 rounded-lg hover:border-blue-200 transition-colors duration-200">
                        <div class="relative">
                            <img src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop" 
                                 alt="Coordinator"
                                 class="rounded-lg w-16 h-16 object-cover border-2 border-slate-300" />
                ...
                @if(Auth::user()->hasRole('Volunteer'))
                    ...
                    <div class="border-t border-slate-200 pt-6">
                        ...
                        @else
                            <div class="text-green-600 font-medium text-sm flex items-center gap-2 justify-center py-3 px-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <aside class="lg:w-1/3 w-full bg-slate-50 border-l border-slate-200 p-6 space-y-5 overflow-y-auto">
                ...
                @foreach ($details as $detail)
                    <div class="bg-white p-4 border border-slate-200 rounded-lg hover:border-blue-200 transition-colors duration-200">
