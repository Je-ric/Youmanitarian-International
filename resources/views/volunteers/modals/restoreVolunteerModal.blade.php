    ...
    <x-modal.body>
        <div class="flex flex-col items-center text-center gap-3">
            <div class="bg-blue-100 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center mb-2">
                <i class='bx bx-undo text-2xl sm:text-3xl text-blue-500'></i>
            </div>
            <h3 class="text-base sm:text-lg font-semibold text-blue-700">Are you sure you want to restore this volunteer?</h3>
