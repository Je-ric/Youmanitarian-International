...
<body class="bg-gray-50 font-sans">
    ...
    <aside 
        id="sidebar" 
        class="fixed top-0 left-0 z-50 h-screen -translate-x-full lg:translate-x-0 bg-white border-r border-gray-200 shadow-lg sidebar-expanded"
        aria-label="Sidebar"
    >
        <div class="h-full overflow-y-auto bg-white">
            ...
            <div class="px-3 py-4">
                ...
                <ul class="space-y-2 font-medium">
                    <!-- Dashboard -->
                    <li>
                        <a href="{{ route('dashboard') }}" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Dashboard">
                    ...
                    <!-- Contents -->
                    <li>
                        <a href="{{ route('content.content_view') }}" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Contents">
                    ...
                    <!-- Programs -->
                    <li>
                        <a href="{{ route('programs.index') }}" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Programs">
                    ...
                    <!-- Volunteers -->
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Volunteers">
                    ...
                    <li>
                        <a href="{{ route('volunteers.requests') }}" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Volunteer Applications">
                    ...
                    <!-- Content Requests -->
                    <li>
                        <a href="{{ route('content_requests.requests_view') }}" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Content Requests">
                    ...
                    <!-- Members -->
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Members">
                    ...
                    <!-- Donations -->
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Donations">
                    ...
                    <!-- Membership Payments -->
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Membership Payments">
                    ...
                    <!-- User Roles -->
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="User Roles">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Settings">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-blue-50 hover:text-blue-700 group sidebar-item" data-tooltip="Help & Support">
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST" class="flex items-center p-3 text-red-600 rounded-lg hover:bg-red-50 group sidebar-item" data-tooltip="Sign Out">
                            @csrf
                            <button type="submit" 
                                class="flex items-center gap-3 w-full px-4 py-2 text-red-600 hover:bg-red-600 hover:text-white rounded-lg sidebar-item group"
    ...
    <!-- Navbar -->
    <nav id="navbar" class="bg-white shadow-lg border-b border-gray-200 fixed w-full top-0 z-40">
    ...
    <!-- Tooltip -->
    <div id="tooltip" class="absolute bg-gray-900 text-white text-sm rounded py-1 px-2 z-50 opacity-0 pointer-events-none"></div>
