                            ...
                            @if (Auth::user()->hasRole('Admin'))
                                <li>
                                    <a href="{{ route('admin.contact-inquiries.index') }}"
                                        class="sidebar-link flex items-center py-2 px-3 rounded-lg transition-all duration-200 group sidebar-item {{ request()->routeIs('admin.contact-inquiries.*') ? 'active' : '' }}"
                                        data-tooltip="Contact Inquiries">
                                        <i class="bx bx-message-dots w-5 text-center flex-shrink-0 text-primary"></i>
                                        <span class="ml-3 sidebar-content text-sm">Contact Inquiries</span>
                                    </a>
                                </li>
                            @endif
