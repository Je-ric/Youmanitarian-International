@php
    ...
    // Get payment options from controller
    $paymentOptions = app(App\Http\Controllers\MembershipReminderController::class)->getPaymentOptions($member);
@endphp
                ...
                <div class="p-4 sm:p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-form.textarea
                            ...
                            class="mt-1"
                            x-model="message"
                            placeholder="Add a personal message or select a template..."
                        ></x-form.textarea>
                    </div>
                </div>
            </x-modal.body>
